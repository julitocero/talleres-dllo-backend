function desglosarString(cadena: string, tipo: string): number {
...
function twoSum(array: number[], expect: number): number[] {
...
function conversionRomana(cadena: string): number {
...
function descomposicion(cadena: string): string[] {
